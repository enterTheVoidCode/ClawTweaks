...
namespace XboxGamingBar.QuickSettings
{
    ...
    public enum TileActionType
    {
        ...
        ToggleHwMouse          = 71,   // MSI Claw: force firmware HW mouse (works on UAC secure desktop); toggle back to controller
    ...
    public static class TileActionHelper
    {
        public static string GetDisplayName(TileActionType action)
        {
            switch (action)
            {
                ...
                case TileActionType.ToggleHwMouse:          return "HW Mouse (UAC)";
        ...
        public static string GetShortName(TileActionType action)
        {
            switch (action)
            {
                ...
                case TileActionType.ToggleHwMouse:          return "HW Mouse";
        ...
        // Fluent System Icons mouse_24_filled — HW-mouse killswitch tile/action.
        private const string PathMouse    = "M12 2C8.13401 2 5 5.13401 5 9V15C5 18.866 8.13401 22 12 22C15.866 22 19 18.866 19 15V9C19 5.13401 15.866 2 12 2ZM12.75 6.75C12.75 6.33579 12.4142 6 12 6C11.5858 6 11.25 6.33579 11.25 6.75V9.25C11.25 9.66421 11.5858 10 12 10C12.4142 10 12.75 9.66421 12.75 9.25V6.75Z";
        ...
        public static string GetFluentIconPath(TileActionType action)
        {
            switch (action)
            {
                ...
                case TileActionType.ToggleHwMouse:             return PathMouse;  // HW-mouse killswitch
        ...
        public static string GetFluentIconPathForTileId(string tileId)
        {
            switch (tileId)
            {
                ...
                case "MsiClawHwMouse":      return PathMouse;     // HW-mouse killswitch (firmware Desktop mouse)
        ...
        public static IEnumerable<TileActionType> GetAllActions()
        {
            ...
            // Special Controller Buttons group — kept at the very bottom.
            yield return TileActionType.EmulateXboxGuide;
            yield return TileActionType.ToggleHwMouse;
        }
    }
