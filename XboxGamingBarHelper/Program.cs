...
namespace XboxGamingBarHelper
{
    internal partial class Program
    {
        ...
        private static void InitializeConnection()
        {
            ...
            try
            {
                ...
                pipeServer.Connected += (s, e) =>
                {
                    ...
                    // MSI Claw: also push the fan auto-safety state, so the fan card's "Auto Sport"
                    // badge reflects an override that engaged while the Game Bar was closed.
                    try { PushMsiFanAutoSportToWidget(); }
                    catch (Exception ex) { Logger.Warn($"Failed to push MSI fan auto-Sport state on connect: {ex.Message}"); }
        ...
        private static async Task Initialize()
        {
            ...
            msiClawHwMouseManager = new MsiClawHwMouseManager();
            wave3Timer.Stop();
            ...
            var propertyList = new List<FunctionalProperty>
            {
                ...
                controllerEmulationManager.ControllerEmulationMouseAcceleration,
                controllerEmulationManager.ControllerEmulationMouseActionSlots,
                controllerEmulationManager.ControllerEmulationMouseDPadActions,
                controllerEmulationManager.ControllerEmulationMouseNudgeStep,
                controllerEmulationManager.ControllerEmulationMouseLeftClickButton,
                controllerEmulationManager.ControllerEmulationMouseRightClickButton,
                controllerEmulationManager.ControllerEmulationMouseCursorStick,
                controllerEmulationManager.ControllerEmulationMouseScrollStick,
            ...
            intelGpuManager.IntelColorHue.PropertyChanged += IntelDisplay_PropertyChanged;
