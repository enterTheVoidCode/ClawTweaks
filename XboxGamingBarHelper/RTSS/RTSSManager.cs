...
namespace XboxGamingBarHelper.RTSS
{
    internal class RTSSManager : OnScreenDisplayManager
    {
        ...
        private readonly OSDItemBlankLine osdItemBlank1, osdItemBlank2, osdItemBlank3, osdItemBlank4, osdItemBlank5;
        ...
        public RTSSManager(PerformanceManager performanceManager) : base()
        {
            ...
            osdItemCPU = new OSDItemCPU(performanceManager.CPUUsage, performanceManager.CPUClock, performanceManager.CPUWattage, performanceManager.CPUTemperature, performanceManager.CPUVoltage);
            ...
            osdItemBlank5 = new OSDItemBlankLine("Blank5");
            ...
            if (IsItemEnabled("FrametimeGraph"))
            {
                try
                {
                    ...
                    if (currentMinFt > 0 && currentMaxFt > 0)
                    {
                        ...
                        statsLabel += $" <C={labelColor}>fps<C><S>";
                    }
