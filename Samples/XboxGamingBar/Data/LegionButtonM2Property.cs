...
{
    /// <summary>
    /// Property for Legion M2 button remap action (0-28 RemapAction values)
    /// </summary>
    internal class LegionButtonM2Property : WidgetControlProperty<int, ComboBox>
    {
        public LegionButtonM2Property(ComboBox inUI, Page inOwner) : base(0, Function.LegionButtonM2, inUI, inOwner)
        {
            if (UI != null)
            {
