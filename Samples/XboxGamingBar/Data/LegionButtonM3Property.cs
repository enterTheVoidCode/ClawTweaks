...
{
    /// <summary>
    /// Property for Legion M3 button remap action (0-28 RemapAction values)
    /// </summary>
    internal class LegionButtonM3Property : WidgetControlProperty<int, ComboBox>
    {
        public LegionButtonM3Property(ComboBox inUI, Page inOwner) : base(0, Function.LegionButtonM3, inUI, inOwner)
        {
            if (UI != null)
            {
