...
{
    /// <summary>
    /// Property for Legion Y2 button remap action (0-28 RemapAction values)
    /// </summary>
    internal class LegionButtonY2Property : WidgetControlProperty<int, ComboBox>
    {
        public LegionButtonY2Property(ComboBox inUI, Page inOwner) : base(0, Function.LegionButtonY2, inUI, inOwner)
        {
            if (UI != null)
            {
