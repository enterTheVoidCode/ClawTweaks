    ...
    internal class LegionManager : Manager
    {
        ...
        public void SetLightMode(int mode)
        {
            ...
            try
            {
                ...
                var result = controllerService.SetStickLightMode(rgbMode, r, g, b, lightBrightness / 100f);
                if (result.Success)
                {
                    lightMode = mode;
        ...
        public void SetLightBrightness(int brightness)
        {
            ...
            try
            {
                ...
                RgbMode rgbMode = (RgbMode)lightMode;
                var result = controllerService.SetStickLightMode(rgbMode, r, g, b, brightness / 100f);
                if (result.Success)
                {
